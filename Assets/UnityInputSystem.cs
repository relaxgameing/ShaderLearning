...
public partial class @UnityInputSystem: IInputActionCollection2, IDisposable
{
    ...
    ~@UnityInputSystem()
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, UnityInputSystem.Player.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, UnityInputSystem.UI.Disable() has not been called.");
    }
    ...
    public struct UIActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public UIActions(@UnityInputSystem wrapper) { m_Wrapper = wrapper; }
        /// <summary>
